...
class TeamMatches extends Component {
  ...
  componentDidMount() {
    this.getAndSetTeamMatchesList()
  }

  getAndSetTeamMatchesList = async () => {
    ...
    const updatedRecentMatches = data.recent_matches.map(eachRecentMatch => ({
      ...
      <div className="app-container">
        {isLoading ? (
          ...
          <div className="team-matches-container">
            ...
            <ul className="recent-matches-container-list">
              {recentMatches.map(eachMatch => (
                <MatchCard key={eachMatch.id} eachMatchInfo={eachMatch} />
              ))}
            </ul>
          </div>
        )}
